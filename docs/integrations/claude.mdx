---
title: "Connect Claude Desktop to MCPJungle"
description: "Use the mcp-remote bridge to connect Claude Desktop to your MCPJungle gateway and give Claude access to all your registered MCP tools."
---
